...
<style>
	...
	*{box-sizing:border-box;}
	...
	.wrapper>main{padding-bottom:80px;}
	.wrapper>main table{
		border:1px solid;
		...
		<main>
			...
			<table border=1 border-collapse=collapse;>
				...
				<tr>
					...
					<%
						// 나이 뽑아내서 포멧팅
						String birth = el.getV_jumin().substring(0, 6);	// yyMMdd
					...
					<%
						// 만나이 계산
						String age = el.getV_jumin().substring(0, 6);	// yyMMdd
					...
					%>
					<%
						char gender = el.getV_jumin().charAt(6);
						if(gender%2==0)
							out.print("<td>여</td>");
						else
							out.print("<td>남</td>");
					...
					<%
						...
						sb.append(el.getV_time());
						sb.insert(2,":");
						out.println("<td>"+sb+"</td>");
					%>
					<%
						if(el.getV_confirm().matches("Y"))
							out.print("<td>확인</td>");
						else
							out.print("<td>미확인</td>");
					%>
