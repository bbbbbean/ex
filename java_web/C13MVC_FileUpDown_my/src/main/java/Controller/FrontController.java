...
@MultipartConfig
(
		fileSizeThreshold = 1024*1024*10,	// 10MB 업로드 파일이 10Mb이상이 될 때 임시 경로(temp)를 지정해 해당 경로에 담아두는 것
		maxFileSize = 1024*1024*50,			// 50Mb 업로드 파일 하나의 최대 크기
		maxRequestSize = 1024*1024*100		// 100Mb request 요청 시 허락의 전체(최대)의 크기
)
