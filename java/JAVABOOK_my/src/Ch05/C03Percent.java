...
public class C03Percent {
	public static void main(String[] args) throws InterruptedException{
		...
		n3=scan.nextInt();
		sum=n1+n2+n3;
		String result2 = (sum%5==0)?"5의배수입니다":"5의 배수가 아닙니다";
...
//		}
		...
		// 02 Math.random();
		while (true) {
			System.out.println(Math.random()*100);	// 자릿수 조정 -> 10, 100 등 곱해서. 난수는 0~1범위
			System.out.println((int)(Math.random()*100)%16);	// 정수로 출력 원할 시 int 형변환, %16 -> 0~15까지 출력한다는 뜻
			System.out.println((int)(Math.random()*100)%45+1);	// %45 == 0~44 => +1해서 1~45로 조정
			Thread.sleep(500);
		}
