...
public class C13Ex {
	public static void main(String[] args) throws Exception, InterruptedException {
		...
		// http://api.openweathermap.org/data/2.5//weather?q=Seoul&appid=049e0593c38e749e43fccda34ddd093f
		
		// URL,PARAM 지정
		// api_key는 따로 관리해야함
		String url = "http://api.openweathermap.org/data/2.5//weather";
		String city = "Seoul";
		String key = "049e0593c38e749e43fccda34ddd093f";
...
//		System.out.println(jsonnode.get("weather"));
//		System.out.println(jsonnode.get("id"));
		
		// Class Type
		Main main = objectMapper.readValue(response.body(), Main.class);
		System.out.println("Temp : "+main.getTemp());
		System.out.println("Pressure : "+main.getPressure());
		System.out.println("Sea Level : "+main.getSea_level());
